...
export const NON_FEA_FIELD_REGISTRY = freezeDeep({
  ...
  fields: [
    ...
    field('SUPPORT_TYPE_CAPABILITIES', 'Support type capabilities', 'policy', ['ACCEPTED_OVERRIDE', 'SOURCE_EXPLICIT', 'EXACT_APPROVED_MASTER', 'PROJECT_POLICY'], 'topology.supportTypeCapabilities', RESTRAINT_METHODS),
