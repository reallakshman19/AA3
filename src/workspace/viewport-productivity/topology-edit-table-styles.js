...
export function ensureTopologyEditTableStyles(documentRef) {
  ...
  style.textContent = `
    ...
    .topology-edit-table-window__body { display:grid; grid-template-columns:minmax(0,1fr); grid-template-rows:minmax(0,1fr); min-width:0; min-height:0; overflow:hidden; padding:5px; background:#07101c; box-sizing:border-box; }
    .topology-edit-table-window__body > [data-role="topology-edit-table"] { display:grid; grid-template-columns:minmax(0,1fr); grid-template-rows:minmax(0,1fr); min-width:0; min-height:0; }
    ...
    .topology-edit-table-window__body > [data-role="topology-edit-table"] > .topology-edit-table--populated { min-width:0; min-height:0; height:auto; }
    ...
    .topology-edit-table--populated > .topology-edit-table__scroll { flex:1 1 0; min-height:0; }
    .topology-edit-table__lower { display:grid; gap:.4rem; min-width:0; min-height:0; max-height:210px; overflow:auto; overscroll-behavior:contain; scrollbar-gutter:stable; padding-right:2px; }
    .topology-edit-table--populated > .topology-edit-table__lower { flex:0 1 auto; }
    ...
    @media (max-width:900px) { .topology-edit-table-window { left:6px !important; right:6px !important; width:auto; max-width:none; } .topology-edit-table__lower { max-height:180px; } }
