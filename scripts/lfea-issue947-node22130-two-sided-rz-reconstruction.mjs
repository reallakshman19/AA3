...
assert.equal(String(e79.FROM_NODE), '21990');
...
const e79LfeaBoundary = boundaryDofVector(productionRows, ['21990','22130']);
const e80LfeaBoundary = boundaryDofVector(productionRows, ['22130','22140']);
const e79CaesarBoundary = boundaryDofVector(referenceRows, ['21990','22130']);
