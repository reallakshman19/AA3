...
BM-002 | Current-main imported/repaired M0-M4 runner. | PASS | Historical failures retained; fresh M0-M4 PASS at 798b2580f, negative-m4-final/
...
RP-0001 is implemented. RP-0002 is implemented; all twelve solver records and fourteen histories are unchanged. LEG-004 changes only the approved shared classifier; physics/oracle limits remain unchanged. Practical/UI/non-affine/reaction qualification remains open.
