...
assert.equal(capability.producerRevision, 'LAFEA.10.T6Q8.SHELL.V10');
...
console.log('LAFEA mesh-producer binding check PASS (P0 + P1-5 + P1-6 holes + P1-7 logical mapped chains + P2-8 planar/cylindrical/curved-hole/periodic/periodic-hole shell automatic generation binding + P2-9 retained local refinement authority)');