...
DEPENDENCY_PR_MERGED: FALSE

## Acceptance ledger

L0 | Freeze Gaussian limit-state context/oracle | PLANNED_NOT_IMPLEMENTED
L1 | Deterministic zero-variance control | NOT_STARTED
L2 | Gaussian limit-state sampling / Pf-beta | NOT_STARTED
L3 | Permutation/order invariance | NOT_STARTED
L4 | Invalid distribution/sample-plan negatives | NOT_STARTED
L5 | Exact-head execution and parent reconciliation | NOT_RUN

## Frozen candidate analytical target
