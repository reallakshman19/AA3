...
function reviewProjection(snapshot, preFlight) {
  ...
  return {
    ...
    findings: findings.map((row) => ({
      ...
      sourceFeatureIds: stringArray(row?.sourceFeatureIds),
      canonicalEntityIds: stringArray(row?.canonicalEntityIds),
      physicalCaseIds: stringArray(row?.physicalCaseIds),
    })),
