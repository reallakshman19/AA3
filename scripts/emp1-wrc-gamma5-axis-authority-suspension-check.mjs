...
function routeFixture() {
  return canonicalFixture((source) => {
    // Physically consistent with +P = source reference -> target = -Z.
    // These global loads retain the historical WRC vector used by the frozen
    // gamma5 comparison while no longer borrowing raw foundation +eZ polarity.
