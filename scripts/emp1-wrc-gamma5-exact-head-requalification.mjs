...
const observationPayload = {
  ...
  tolerancePolicy,
  physicalWrcLoadComparisons: structuredClone(physicalLoadComparisons),
  stressComparisonsRequired: 32,
  stressComparisonsPassed: comparisons.length,
  stressComparisons: structuredClone(comparisons),
  ...
  governingComparison: structuredClone(governing),
