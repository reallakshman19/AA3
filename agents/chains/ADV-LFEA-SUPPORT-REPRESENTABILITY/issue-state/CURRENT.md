...
TASK-002 | CNODE terminal refusal closure | PARTIAL | finite bidirectional CNODE spring lands exact DRAFT; rigid CNODE deliberately refused pending MPC
...
TASK-004 | exercise + refusal models per feature | PASS_SOURCE | positive skew/CNODE/HANGER plus rigid-skew, rigid-CNODE and incomplete-HANGER refusal fixtures retained
TASK-005 | feature checks + observed deliberate-break red | BLOCKED | checks/break modes authored; exact-head execution remains NOT_RUN_RUNTIME; only prior extracted HANGER custody break evidence is supplemental
TASK-006 | frozen BM4_L non-regression | BLOCKED | frozen target 96.76 / 93.00 / 95.82 / 7.99%; exact-head BM4 remains NOT_RUN_RUNTIME
TASK-007 | spring-rate units converted/fail closed | PASS_SOURCE | unresolved finite rate cannot silently become FIXED/factor-1; exact-head runtime still NOT_RUN
...
INPUT-002 | SPRING_DRAFT provenance/fixtures | AVAILABLE | self-authored exercise authority only
...
RM-002 | Common engineering-pr-delivery-v2@4b3a7a9c7ca2fac4a9182ef0028135d17eafaf02 | PROCESS_POLICY | PRIMARY | ALIGNED | GitHub-Issue control plane active/read-only
