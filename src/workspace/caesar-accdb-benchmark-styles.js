...
.caesar-accdb-benchmark__scroll{max-height:340px;overflow:auto}.caesar-accdb-benchmark table{width:100%;border-collapse:collapse;font-size:12px}.caesar-accdb-benchmark th,.caesar-accdb-benchmark td{padding:5px 7px;border:1px solid #334155;text-align:left;vertical-align:top}.caesar-accdb-benchmark__cell-number{text-align:right;font:12px ui-monospace,monospace;white-space:nowrap}.caesar-accdb-benchmark__cell-status{font-weight:800}
