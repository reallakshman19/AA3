...
export function ensureTopologyEditTableStyles(documentRef) {
  ...
  style.textContent = `
    ...
    .topology-edit-table--populated { grid-template-rows:auto minmax(140px,62%) auto; grid-auto-rows:auto; }
    ...
    .topology-edit-table__scroll { min-width:0; min-height:140px; max-height:none; overflow:auto; overscroll-behavior:contain; scrollbar-gutter:stable both-edges; border:1px solid #1e344c; border-radius:.3rem; background:#050c16; }
    ...
    @media (max-width:900px) { .topology-edit-table-window { left:6px !important; right:6px !important; width:auto; max-width:none; } .topology-edit-table--populated { grid-template-rows:auto minmax(120px,58%) auto; } }
