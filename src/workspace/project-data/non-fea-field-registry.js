...
export const NON_FEA_FIELD_REGISTRY = freezeDeep({
  ...
  fields: [
    ...
    field('FORCE_OUTPUT_CONVENTION', 'Force output convention', 'convention', ['PROJECT_POLICY', 'PROJECT_CONFIGURED_DEFAULT', 'PRODUCT_DEFAULT'], 'loadCalculation.forceOutputConvention', ['WEIGHT_AND_GRAVITY'], true),
    field('MOMENT_OUTPUT_CONVENTION', 'Moment output convention', 'convention', ['PROJECT_POLICY', 'PROJECT_CONFIGURED_DEFAULT', 'PRODUCT_DEFAULT'], 'loadCalculation.momentOutputConvention', ['WEIGHT_AND_GRAVITY'], true),
    field('GRAVITY_ANALYSIS_BASIS', 'Gravity analysis basis', 'analysis-basis', ['PROJECT_POLICY', 'PROJECT_CONFIGURED_DEFAULT', 'PRODUCT_DEFAULT'], 'loadCalculation.analysisBasis', ['WEIGHT_AND_GRAVITY'], true),
    field('RESULT_SIGN_CONVENTION', 'Gravity result sign convention', 'convention', ['PROJECT_POLICY', 'PROJECT_CONFIGURED_DEFAULT', 'PRODUCT_DEFAULT'], 'loadCalculation.resultSignConvention', ['WEIGHT_AND_GRAVITY'], true),
    ...
    field('COMPONENT_OPERATING_FLUID_WEIGHT', 'Component operating contained-fluid mass', 'kg', COMPONENT_CONTENT_DEFAULT_AUTHORITIES, null, WEIGHT_METHODS, true),
    field('COMPONENT_HYDRO_FLUID_WEIGHT', 'Component hydrotest contained-fluid mass', 'kg', COMPONENT_CONTENT_DEFAULT_AUTHORITIES, null, WEIGHT_METHODS, true),
