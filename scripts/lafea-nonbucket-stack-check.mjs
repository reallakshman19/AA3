...
const CHECKS = Object.freeze([
  ...
  { scope: 'COMPILED_INPUT', path: 'scripts/lafea-continuum-compiled-input-check.mjs' },
  { scope: 'COMPILED_EXECUTION', path: 'scripts/lafea-continuum-compiled-execution-check.mjs' },
  { scope: 'AUTHORITATIVE_CONTINUUM', path: 'scripts/lafea-continuum-authoritative-run-check.mjs' },
...
const report = Object.freeze({
  schema: 'lafea-nonbucket-stack-report/v23',
  ...
  continuumCompiledInputLoweringIntegrated: true,
  continuumCompiledInputRunsSolver: false,
  continuumCompiledInputReleaseAuthorityChanged: false,
  ...
  authoritativeContinuumRunChanged: true,
  authoritativeContinuumRunIntegrated: true,
  authoritativeContinuumRunRequiresPreflight: true,
  authoritativeContinuumRunUsesExistingKernel: true,
  authoritativeContinuumRunPublishesLifecycleExecutionRecovery: true,
  authoritativeContinuumRunReleaseAuthorityChanged: false,
  ...
  numericalAuthorityChanged: true,
