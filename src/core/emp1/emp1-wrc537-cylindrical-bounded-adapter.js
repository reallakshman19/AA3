...
const FIGURES=deepFreeze({
  circ:{
    ...
    Mcmem:'3A',Mcbend:'1A',Mlmem:'3B',Mlbend:'1B-1',
  },
  long:{
    Pmem_AB:'3C',Pmem_CD:'4C',Pbend_AB:'1C-1',Pbend_CD:'2C',
    Mcmem:'4A',Mcbend:'2A',Mlmem:'4B',Mlbend:'2B-1',
  },
});
...
export function evaluateEmp1Wrc537CylindricalBoundedAdapter(input){
  ...
  const geometry=deriveGeometry(input.geometry);
...
function deriveGeometry(value){
  ...
  const attachmentRadius=positive(value.attachmentRadius,'ATTACHMENT_RADIUS');
