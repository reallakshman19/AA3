...
ACTIVE_ENDPOINT_FILE: agents/chains/ADV-EMP1-WRC-UI-WALKTHROUGH/endpoints/EP-0035.md
...
STATE: POST_MERGE_EXECUTION_ENVIRONMENT_PREREQUISITES_BLOCKED_HANDOVER_READY
...
LATEST_EXECUTION_PROBE: post-merge retry on main 2bade51fc8207db4cc7934de3b8cb6771e41e9e8; Node v22.16.0 and /usr/bin/chromium available; @playwright/test/playwright/vite absent; git ls-remote github.com failed DNS; npm registry failed EAI_AGAIN
